...
const App: React.FC = () => {
  ...
  const handleButtonClick = (isCorrect: boolean) => {
    if (isCorrect) {
      ...
      setTimeout(() => {
        setLevel(level);
        navigation.navigate('nivel2pagina8');
      }, 1000);
    } else {
      ...
      <View style={styles.container}>
        <View style={styles.topContainer}>
          <View style={styles.topBar}>
            ...
            O que é o conceito de "dividend yield" em investimentos?
        ...
        <View style={styles.middleContainer}>
          ...
          >
            ...
            a) A taxa de crescimento dos dividendos
          ...
          >
            ...
            b) O retorno total de um investimento
          ...
          >
            ...
            c) O rendimento anual dos dividendos em relação ao preço da ação
          ...
          >
            ...
            d) A porcentagem de dividendos reinvestidos
