...
const App: React.FC = () => {
  ...
  const handleButtonClick = (isCorrect: boolean) => {
    if (isCorrect) {
      ...
      setTimeout(() => {
        setLevel(level);
        navigation.navigate('nivel2pagina2');
      }, 1000);
    } else {
      ...
      <View style={styles.container}>
        <View style={styles.topContainer}>
          <View style={styles.topBar}>
            <Text style={styles.topBarText}>Qual é o principal objetivo de diversificar um portfólio de investimentos?</Text>
          </View>
        </View>
        <View style={styles.middleContainer}>
          ...
          >
            <Text style={styles.buttonText}>A) Maximizar o risco</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
              styles.button,
            ...
            onPress={() => handleButtonClick(false)}
          >
            <Text style={styles.buttonText}>B) Minimizar o retorno
</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
            ...
            onPress={() => handleButtonClick(false)}
          >
            <Text style={styles.buttonText}>C) Maximizar o retorno
</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
          ...
          >
            <Text style={styles.buttonText}>D) Minimizar o risco</Text>
          </TouchableOpacity>
