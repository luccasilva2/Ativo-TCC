...
const App: React.FC = () => {
  ...
  const handleButtonClick = (isCorrect: boolean) => {
    if (isCorrect) {
      ...
      setTimeout(() => {
        setLevel(level);
        navigation.navigate('nivel2pagina10');
      }, 1000);
    } else {
      ...
      <View style={styles.container}>
        <View style={styles.topContainer}>
          <View style={styles.topBar}>
            ...
            O que é uma estratégia de "buy and hold" em investimentos?
        ...
        <View style={styles.middleContainer}>
          ...
          >
            ...
            a) Comprar e vender rapidamente para obter lucros
          ...
          >
            ...
            b) Comprar e manter investimentos a longo prazo
          ...
          >
            ...
            c) Comprar ações de empresas em dificuldades financeiras
          ...
          >
            ...
            d) Comprar e vender repetidamente no mesmo dia
