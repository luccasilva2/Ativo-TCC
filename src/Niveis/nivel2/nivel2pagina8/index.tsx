...
const App: React.FC = () => {
  ...
  const handleButtonClick = (isCorrect: boolean) => {
    if (isCorrect) {
      ...
      setTimeout(() => {
        setLevel(level);
        navigation.navigate('nivel2pagina9');
      }, 1000);
    } else {
      ...
      <View style={styles.container}>
        <View style={styles.topContainer}>
          <View style={styles.topBar}>
            ...
            Qual é o principal fator que determina a taxa de juros em uma economia?
        ...
        <View style={styles.middleContainer}>
          ...
          >
            ...
            a) Oferta e demanda por empréstimos
