...
const App: React.FC = () => {
  ...
  const handleButtonClick = (isCorrect: boolean) => {
    if (isCorrect) {
      ...
      setTimeout(() => {
        setLevel(level);
        navigation.navigate('nivel2pagina3');
      }, 1000);
    } else {
      ...
      <View style={styles.container}>
        <View style={styles.topContainer}>
          <View style={styles.topBar}>
            <Text style={styles.topBarText}>Qual das seguintes opções é considerada uma forma de investimento de baixo risco?
</Text>
          </View>
        </View>
        <View style={styles.middleContainer}>
          ...
          >
            <Text style={styles.buttonText}>
              ...
              A) Ações de empresas iniciantes
</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
