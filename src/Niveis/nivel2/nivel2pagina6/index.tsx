...
const App: React.FC = () => {
  ...
  const handleButtonClick = (isCorrect: boolean) => {
    if (isCorrect) {
      ...
      setTimeout(() => {
        setLevel(level);
        navigation.navigate('nivel2pagina7');
      }, 1000);
    } else {
      ...
      <View style={styles.container}>
        <View style={styles.topContainer}>
          <View style={styles.topBar}>
            ...
            Qual é a principal diferença entre investir em ações ordinárias e investir em títulos?
        ...
        <View style={styles.middleContainer}>
          ...
          >
            ...
            a) Ações representam propriedade na empresa
          ...
          >
            ...
            b) Títulos garantem retornos fixos
          ...
          >
            ...
            c) Ações oferecem maior liquidez
          ...
          >
            ...
            d) Títulos não estão sujeitos a riscos de mercado
