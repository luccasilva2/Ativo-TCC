...
const App: React.FC = () => {
  ...
  const handleButtonClick = (isCorrect: boolean) => {
    if (isCorrect) {
      ...
      setTimeout(() => {
        setLevel(level);
        navigation.navigate('nivel2pagina6');
      }, 1000);
    } else {
      ...
      <View style={styles.container}>
        <View style={styles.topContainer}>
          <View style={styles.topBar}>
            ...
            O que é o conceito de "prazo de investimento"?
        ...
        <View style={styles.middleContainer}>
          ...
          >
            ...
            a) O período durante o qual você mantém um investimento antes de vendê-lo
          ...
          >
            ...
            b) O tempo necessário para que um investimento se torne rentável
          ...
          >
            ...
            c) O período durante o qual você pode retirar fundos de um investimento
          ...
          >
            ...
            d) O tempo que um investimento leva para amadurecer
