...
const NovaPagina: React.FC = () => {
  ...
  const [completedlevels, setCompletedLevel] = useState<number>(1);
    ...
    >
      <View style={styles.container}>
        <Text style={styles.textoNoMeio}>
          Parabéns, você completou a página {completedlevels}, se sinta privilegiado! Agora é mão na massa, a bola pra frente!!!
        </Text>
