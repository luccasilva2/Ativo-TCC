    ...
    >
      <View style={styles.container}>
        ...
        <View style={styles.middleContainer}>
          ...
          >
            <Text style={styles.buttonText}>
              B) Redução nos preços dos bens e serviços
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
          ...
          >
            <Text style={styles.buttonText}>
              C) Aumento geral nos preços dos bens e serviços ao longo do tempo
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
