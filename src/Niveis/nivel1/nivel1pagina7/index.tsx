...
const App: React.FC = () => {
  ...
  const handleButtonClick = (isCorrect: boolean) => {
    if (isCorrect) {
      ...
      setTimeout(() => {
        setLevel(level);
        navigation.navigate('nivel1pagina8');
      }, 1000);
    } else {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.topContainer}>
          <View style={styles.topBar}>
            <Text style={styles.topBarText}>O que é o mercado de câmbio?</Text>
          </View>
        </View>
        <View style={styles.middleContainer}>
          ...
          >
            <Text style={styles.buttonText}>A) Mercado para compra e venda de moedas estrangeiras</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
              styles.button,
          ...
          >
            <Text style={styles.buttonText}>B) Mercado para compra de ações</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
              styles.button,
            ...
            onPress={() => handleButtonClick(false)}
          >
            <Text style={styles.buttonText}>C) Mercado exclusivo para grandes investidores</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
              styles.button,
            ...
            onPress={() => handleButtonClick(false)}
          >
            <Text style={styles.buttonText}>D) Mercado para compra de imóveis</Text>
          </TouchableOpacity>
