...
const App: React.FC = () => {
  ...
  const handleButtonClick = (isCorrect: boolean) => {
    if (isCorrect) {
      ...
      setTimeout(() => {
        setLevel(level);
        navigation.navigate('nivel1pagina5');
      }, 1000);
    } else {
      ...
      <View style={styles.container}>
        <View style={styles.topContainer}>
          ...
          <View style={styles.topBar}>
            <Text style={styles.topBarText}>O que é um orçamento?</Text>
          </View>
        </View>
        <View style={styles.middleContainer}>
          ...
          >
            <Text style={styles.buttonText}>A) Lista de desejos</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
              styles.button,
          ...
          >
            <Text style={styles.buttonText}>B) Plano para gastar dinheiro</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
              styles.button,
            ...
            onPress={() => handleButtonClick(false)}
          >
            <Text style={styles.buttonText}>C) Economizar dinheiro para o futuro</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
              styles.button,
            ...
            onPress={() => handleButtonClick(false)}
          >
            <Text style={styles.buttonText}>D) Ignorar as finanças pessoais</Text>
          </TouchableOpacity>
