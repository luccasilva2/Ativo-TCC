...
const App: React.FC = () => {
  ...
  const handleButtonClick = (isCorrect: boolean) => {
    if (isCorrect) {
      ...
      setTimeout(() => {
        setLevel(level);
        navigation.navigate('nivel1pagina7');
      }, 1000);
    } else {
      ...
      <View style={styles.container}>
        <View style={styles.topContainer}>
          ...
          <View style={styles.topBar}>
            <Text style={styles.topBarText}>O que é um empréstimo?</Text>
          </View>
        </View>
        <View style={styles.middleContainer}>
          ...
          >
            <Text style={styles.buttonText}>A) Dar dinheiro a alguém</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
              styles.button,
          ...
          >
            <Text style={styles.buttonText}>B) Pedir dinheiro emprestado</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
              styles.button,
            ...
            onPress={() => handleButtonClick(false)}
          >
            <Text style={styles.buttonText}>C) Gastar dinheiro em compras</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
              styles.button,
            ...
            onPress={() => handleButtonClick(false)}
          >
            <Text style={styles.buttonText}>D) Presentear dinheiro</Text>
          </TouchableOpacity>
