...
const App: React.FC = () => {
  ...
  const handleButtonClick = (isCorrect: boolean) => {
    if (isCorrect) {
      ...
      setTimeout(() => {
        setLevel(level);
        navigation.navigate('nivel1pagina10');
      }, 1000);
    } else {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.middleContainer}>
          ...
          >
            ...
            B) Total de bens e serviços produzidos em um país
          ...
          >
            ...
            C) Valor total de investimentos em uma empresa
          ...
          >
            ...
            D) Valor total de dívidas de um país
