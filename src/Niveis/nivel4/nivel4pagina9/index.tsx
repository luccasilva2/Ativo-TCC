...
const App: React.FC = () => {
  ...
  const handleButtonClick = (isCorrect: boolean) => {
    if (isCorrect) {
      ...
      setTimeout(() => {
        setLevel(level);
        navigation.navigate('nivel4pagina10');
      }, 1000);
    } else {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.middleContainer}>
          ...
          >
            ...
            a) Título de dívida emitido pelo governo
          ...
          >
            ...
            b) Título emitido por empresas para captação de recursos
          ...
          >
            ...
            c) Título emitido por bancos para captação de recursos
          ...
          >
            ...
            d) Título lastreado em commodities
