...
const App: React.FC = () => {
  ...
  const handleButtonClick = (isCorrect: boolean) => {
    if (isCorrect) {
      ...
      setTimeout(() => {
        setLevel(level);
        navigation.navigate('nivel4pagina8');
      }, 1000);
    } else {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.middleContainer}>
          ...
          >
            ...
            a) Uma ordem para comprar ações quando o preço atinge um certo limite
          ...
          >
            ...
            b) Uma ordem para vender ações quando o preço atinge um certo limite
          ...
          >
            ...
            c) Uma ordem para comprar ações a qualquer preço
          ...
          >
            ...
            d) Uma ordem para vender ações a qualquer preço
