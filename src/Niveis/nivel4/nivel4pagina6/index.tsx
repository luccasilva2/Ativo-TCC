...
const App: React.FC = () => {
  ...
  const handleButtonClick = (isCorrect: boolean) => {
    if (isCorrect) {
      ...
      setTimeout(() => {
        setLevel(level);
        navigation.navigate('nivel4pagina7');
      }, 1000);
    } else {
      ...
      <View style={styles.container}>
        <View style={styles.topContainer}>
          <View style={styles.topBar}>
            ...
            Qual é o principal indicador de desempenho usado para avaliar um fundo de investimento?
        ...
        <View style={styles.middleContainer}>
          ...
          >
            ...
            c) Valor de mercado da empresa emissora
