...
const App: React.FC = () => {
  ...
  const handleButtonClick = (isCorrect: boolean) => {
    if (isCorrect) {
      ...
      setTimeout(() => {
        setLevel(level);
        navigation.navigate('nivel4pagina4');
      }, 1000);
    } else {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.middleContainer}>
          ...
          >
            ...
            b) Investir apenas em ações de uma mesma empresa
          ...
          >
            ...
            c) Distribuir os investimentos entre diferentes tipos de ativos
          ...
          >
            ...
            d) Manter todo o dinheiro na forma de poupança
