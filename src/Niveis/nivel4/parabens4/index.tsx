...
const NovaPagina: React.FC = () => {
  ...
  const [completedlevels, setCompletedLevel] = useState<number>(4);
    ...
    >
      <View style={styles.container}>
        <Text style={styles.textoNoMeio}>
          Parabéns, você terminou mais um nível, o nível {completedlevels} está completo!! O progresso já está vindo, agora é foco e garra!!!
        </Text>
