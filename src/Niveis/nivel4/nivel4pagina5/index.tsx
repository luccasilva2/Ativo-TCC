...
const App: React.FC = () => {
  ...
  const handleButtonClick = (isCorrect: boolean) => {
    if (isCorrect) {
      ...
      setTimeout(() => {
        setLevel(level);
        navigation.navigate('nivel4pagina6');
      }, 1000);
    } else {
      ...
      <View style={styles.container}>
        <View style={styles.topContainer}>
          <View style={styles.topBar}>
            ...
            O que é uma IPO (Oferta Pública Inicial)?
        ...
        <View style={styles.middleContainer}>
          ...
          >
            ...
            a) Oferta de produtos bancários para o público em geral
          ...
          >
            ...
            b) Primeira venda de ações de uma empresa ao público  
          ...
          >
            ...
            c) Lançamento de um novo modelo de investimento
          ...
          >
            ...
            d) Abertura de uma conta de investimento pessoal
