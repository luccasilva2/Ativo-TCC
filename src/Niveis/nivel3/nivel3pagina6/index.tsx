...
const App: React.FC = () => {
  ...
  const handleButtonClick = (isCorrect: boolean) => {
    if (isCorrect) {
      ...
      setTimeout(() => {
        setLevel(level);
        navigation.navigate('nivel3pagina7');
      }, 1000);
    } else {
      ...
      <View style={styles.container}>
        <View style={styles.topContainer}>
          <View style={styles.topBar}>
            ...
            Qual é a principal vantagem de investir em um fundo mútuo?
        ...
        <View style={styles.middleContainer}>
          ...
          >
            ...
            d) Controle total sobre os investimentos
