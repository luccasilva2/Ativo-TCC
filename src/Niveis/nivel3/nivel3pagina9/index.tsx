...
const App: React.FC = () => {
  ...
  const handleButtonClick = (isCorrect: boolean) => {
    if (isCorrect) {
      ...
      setTimeout(() => {
        setLevel(level);
        navigation.navigate('nivel3pagina10');
      }, 1000);
    } else {
      ...
      <View style={styles.container}>
        <View style={styles.topContainer}>
          <View style={styles.topBar}>
            ...
            O que é o conceito de "horizonte de investimento"?
        ...
        <View style={styles.middleContainer}>
          ...
          >
            ...
            a) Prazo durante o qual um investidor espera manter um investimento
          ...
          >
            ...
            b) Valor mínimo necessário para iniciar um investimento
          ...
          >
            ...
            c) Taxa de retorno esperada de um investimento
          ...
          >
            ...
            d) Número de transações realizadas em um dia no mercado financeiro
