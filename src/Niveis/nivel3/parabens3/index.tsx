...
const NovaPagina: React.FC = () => {
  ...
  const [completedlevels, setCompletedLevel] = useState<number>(3);
    ...
    >
      <View style={styles.container}>
        <Text style={styles.textoNoMeio}>
          Olha, meu parabéns, você completou outro nível, o nível {completedlevels}, parabéns! Continue com esse progresso!!!
        </Text>
