...
const App: React.FC = () => {
  ...
  const handleButtonClick = (isCorrect: boolean) => {
    if (isCorrect) {
      ...
      setTimeout(() => {
        setLevel(level);
        navigation.navigate('nivel3pagina3');
      }, 1000);
    } else {
      ...
      <View style={styles.container}>
        <View style={styles.topContainer}>
          <View style={styles.topBar}>
            ...
            Qual é uma característica chave dos investimentos em ações?
        ...
        <View style={styles.middleContainer}>
          ...
          >
            ...
            c) Propriedade parcial de uma empresa
          ...
          >
            ...
            d) Garantia de retorno do investimento
