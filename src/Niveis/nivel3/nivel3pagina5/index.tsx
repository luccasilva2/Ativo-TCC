...
const App: React.FC = () => {
  ...
  const handleButtonClick = (isCorrect: boolean) => {
    if (isCorrect) {
      ...
      setTimeout(() => {
        setLevel(level);
        navigation.navigate('nivel3pagina6');
      }, 1000);
    } else {
      ...
      <View style={styles.container}>
        <View style={styles.topContainer}>
          <View style={styles.topBar}>
            ...
            O que é uma obrigação de renda fixa?
        ...
        <View style={styles.middleContainer}>
          ...
          >
            ...
            a) Um título que paga uma taxa de juros fixa
          ...
          >
            ...
            b) Um investimento com retornos variáveis
          ...
          >
            ...
            c) Um título emitido por empresas para financiar operações
