...
const App: React.FC = () => {
  ...
  const handleButtonClick = (isCorrect: boolean) => {
    if (isCorrect) {
      ...
      setTimeout(() => {
        setLevel(level);
        navigation.navigate('nivel3pagina9');
      }, 1000);
    } else {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.middleContainer}>
          ...
          >
            ...
            b) A previsibilidade dos retornos
          ...
          >
            ...
            c) A liquidez dos investimentos
          ...
          >
            ...
            d) A isenção de impostos sobre os rendimentos
