...
const App: React.FC = () => {
  ...
  const handleButtonClick = (isCorrect: boolean) => {
    if (isCorrect) {
      ...
      setTimeout(() => {
        setLevel(level);
        navigation.navigate('nivel3pagina8');
      }, 1000);
    } else {
      ...
      <View style={styles.container}>
        <View style={styles.topContainer}>
          <View style={styles.topBar}>
            ...
            Qual é a principal desvantagem de investir em ações?
        ...
        <View style={styles.middleContainer}>
          ...
          >
            ...
            b) Risco de perda total do investimento
          ...
          >
            ...
            d) Isenção de impostos sobre os ganhos
