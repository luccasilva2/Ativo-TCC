...
const App: React.FC = () => {
  ...
  const handleButtonClick = (isCorrect: boolean) => {
    if (isCorrect) {
      ...
      setTimeout(() => {
        setLevel(level);
        navigation.navigate('nivel3pagina4');
      }, 1000);
    } else {
      ...
      <View style={styles.container}>
        <View style={styles.topContainer}>
          <View style={styles.topBar}>
            ...
            O que é o mercado de câmbio (Forex)?
        ...
        <View style={styles.middleContainer}>
          ...
          >
            ...
            a) Mercado para comprar e vender casas
          ...
          >
            ...
            b) Mercado para troca de moedas estrangeiras
          ...
          >
            ...
            c) Mercado para comprar e vender ações
          ...
          >
            ...
            d) Mercado para produtos agrícolas
