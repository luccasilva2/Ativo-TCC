      ...
      <View style={styles.container}>
        <View style={styles.topContainer}>
          <View style={styles.topBar}>
            <Text style={styles.topBarText}>Continue assim, o aprendizado é a chave para o sucesso e o dinheiro é a consequência</Text>
        ...
        <View style={styles.middleContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => navigation.navigate('nivel3pagina1')}
          >
            <Text style={styles.buttonText}>Boraaa!!</Text>
          </TouchableOpacity>
