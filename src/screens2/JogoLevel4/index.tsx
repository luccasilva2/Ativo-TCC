      ...
      <View style={styles.container}>
        <View style={styles.topContainer}>
          <View style={styles.topBar}>
            <Text style={styles.topBarText}>A constância é a chave para tudo, apenas faça e veja os resultados virem a seu favor</Text>
        ...
        <View style={styles.middleContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => navigation.navigate('nivel4pagina1')}
          >
